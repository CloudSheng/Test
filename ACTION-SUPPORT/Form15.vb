...
Public Class Form15
    ...
    Private Sub ExportToExcel()
        ...
        For i As Integer = 0 To 11
            ...
            oCommand.CommandText += "and pmn04 in ( select distinct bmb03 from bmb_file ) group by pmn04 having count(pmn04) = 1 )"
        ...
        For i As Integer = 0 To 11
            ...
            oCommand.CommandText += DStartN.ToString("yyyy/MM/dd") & "','yyyy/mm/dd') and to_date('"
            oCommand.CommandText += DstartE.ToString("yyyy/MM/dd") & "','yyyy/mm/dd') and pmm18 = 'Y' and pmm25 in (1,2,6) and pmm02 in ('REG','EXP') "
            oCommand.CommandText += "and pmn04 in ( select distinct bmb03 from bmb_file ) group by pmn04,ima02,ima021,pmm01,pmm04,pmn07,pmn20,pmc03,pmn24,pmm22,pmn31,(pmm31*pmn20),gen02 having count(pmn04) = 1 "
            oReader = oCommand.ExecuteReader()
            If oReader.HasRows() Then
                While oReader.Read()
