...
Public Class Form114
    ...
    Private Sub ExportToExcel()
        ...
        Dim XB As Excel.Chart = Ws.Shapes.AddChart(xlColumnClustered, 50, 1100, 2500, 400).Chart
        ...
        Dim XC As Excel.Chart = Ws.Shapes.AddChart(xlPie, 350, 1600, 400, 400).Chart
        ...
        Dim XD As Excel.Chart = Ws.Shapes.AddChart(xlPie, 350, 2100, 400, 400).Chart
