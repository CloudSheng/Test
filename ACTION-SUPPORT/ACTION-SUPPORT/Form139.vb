Public Class Form139
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        For i As Integer = 0 To DataGridView1.Rows.Count - 1 Step 1
            oCommand.CommandText = "select count(*) from pia_file where pia01 like 'D1501-1908%' and pia19 = 'N' and pia03 in ('D111501') and pia02 = '" & DataGridView1.Rows(i).Cells("料号").Value & "'"
            Dim HData As Decimal = oCommand.ExecuteScalar()
            If HData > 0 Then  ' 有資料就回寫
                oCommand.CommandText = "UPDATE PIA_FILE SET PIA30 = " & DataGridView1.Rows(i).Cells("数量").Value & ",pia901 = 'X' WHERE pia01 like 'D1501-1908%' and pia19 = 'N' and pia03 in ('D111501') and pia02 = '" & DataGridView1.Rows(i).Cells("料号").Value & "'"
                Try
                ...
                End Try
            Else   ' 無資料要新增
                oCommand.CommandText = "select Min(pia01) from pia_file where pia01 like 'D1501-1908%' and pia16 = 'Y' and pia02 is null"
                ...
                oCommand.CommandText = "UPDATE pia_file SET pia02 = '" & DataGridView1.Rows(i).Cells("料号").Value & "',pia03 ='D111501',pia04 = ' ',pia05 = ' ',pia08 =0,pia09 = '" & pia09 & "',pia10 = 1,pia30 = " & DataGridView1.Rows(i).Cells("数量").Value & ",pia901 = 'X' where pia01 = '" & PIa01 & "'"
                Try
                    oCommand.ExecuteNonQuery()
                Catch ex As Exception
                    MsgBox(ex.Message())
        ...
        oCommand.CommandText = "UPDATE pia_file set pia30 = 0 WHERE pia01 like 'D1501-1908%' and pia19 = 'N' and pia03 in ('D111501') and pia901 is null "
        Try
            oCommand.ExecuteNonQuery()
        Catch ex As Exception
            MsgBox(ex.Message())
