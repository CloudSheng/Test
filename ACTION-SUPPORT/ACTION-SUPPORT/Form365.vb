Public Class Form365
    ...
    Private Sub Form365_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        '    'oCommand.CommandText = "DELETE tc_pro_file WHERE tc_pro01 = '" & DataGridView1.Rows(I).Cells("ERPPN").Value & "'"
        '    Try
        ...
        '    End Try
        'Next
        oCommand.CommandText = "DELETE FROM tc_pro_file"
        Try
            oCommand.ExecuteNonQuery()
        Catch ex As Exception
            'MsgBox(ex.Message())
        ...
        For i As Integer = 0 To DataGridView1.Rows.Count - 1 Step 1
            ...
            Me.Label3.Refresh()
            oCommand.CommandText = "INSERT INTO tc_pro_file (tc_pro01,tc_pro02,tc_pro03,tc_pro04,tc_prolegal) VALUES ('"
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        tYear = TextBox1.Text
        For I As Integer = 0 To DataGridView1.Rows.Count - 1 Step 1
            oCommand3.CommandText = "select count(*) as temp_cnt from tc_pro_file "
            oCommand3.CommandText += " WHERE tc_pro01 = '" & DataGridView1.Rows(I).Cells("ERPPN").Value & "' AND "
            oCommand3.CommandText += "       tc_pro02 = " & DataGridView1.Rows(I).Cells("Year").Value & " AND "
            oCommand3.CommandText += "       tc_pro03 = " & DataGridView1.Rows(I).Cells("WeekNum").Value
            ...
            If temp_cnt > 0 Then
                oCommand.CommandText = "update tc_pro_file SET tc_pro04 = '" & DataGridView1.Rows(I).Cells("Inbound").Value & "'"
                oCommand.CommandText += " WHERE tc_pro01 = '" & DataGridView1.Rows(I).Cells("ERPPN").Value & "' AND "
                oCommand.CommandText += "       tc_pro02 = " & DataGridView1.Rows(I).Cells("Year").Value & " AND "
                oCommand.CommandText += "       tc_pro03 = " & DataGridView1.Rows(I).Cells("WeekNum").Value
                Try
                    oCommand.ExecuteNonQuery()
                Catch ex As Exception
                    MsgBox(ex.Message())
