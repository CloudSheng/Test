Public Class Form358
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If selectOK = System.Windows.Forms.DialogResult.OK Then
            ...
            Dim ExcelString = "SELECT ERPPN,Year,WeekNum,Inbound,Legal FROM [sheet1$] Where Year >= " & tYear
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        For i As Integer = 0 To DataGridView1.Rows.Count - 1 Step 1
            ...
            oCommand.CommandText += DataGridView1.Rows(i).Cells("ERPPN").Value & "'," & DataGridView1.Rows(i).Cells("Year").Value & "," & DataGridView1.Rows(i).Cells("WeekNum").Value & "," & DataGridView1.Rows(i).Cells("Inbound").Value & ",'" & DataGridView1.Rows(i).Cells("Legal").Value & "')"
            '191205 add by Brady END
            Try
                oCommand.ExecuteNonQuery()
            Catch ex As Exception
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        For I As Integer = 0 To DataGridView1.Rows.Count - 1 Step 1
            ...
            oCommand3.CommandText += "       tc_prmlegal = '" & DataGridView1.Rows(I).Cells("Legal").Value & "' AND "           '191205 add by Brady
            ...
            If temp_cnt > 0 Then
                ...
                oCommand.CommandText += "       tc_prmlegal = '" & DataGridView1.Rows(I).Cells("Legal").Value & "' AND "        '191205 add by Brady
