Public Class Form185
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If selectOK = System.Windows.Forms.DialogResult.OK Then
            ...
            For i As Int16 = 0 To DS.Tables("table1").Rows.Count - 1 Step 1
                mSQLS1.CommandText = "INSERT INTO IES5 VALUES ('" & DS.Tables("table1").Rows(i).Item(0) & "','" & DS.Tables("table1").Rows(i).Item(1) & "','" & DS.Tables("table1").Rows(i).Item(2) & "','" & DS.Tables("table1").Rows(i).Item(3) & "','"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Me.BackgroundWorker1.IsBusy() Then
            ...
            Return
        End If
        Dim XPath = "C:\temp\IES5_Template.xlsx"
