...
Public Class Form30
    ...
    Private Sub AdjustExcelFormat1()
        ...
        Ws.Cells(4, 3) = "  项目立项日期（Project Start Date）"
        Ws.Cells(4, 4) = "项目负责人（Project Leader） "
        Ws.Cells(4, 5) = "材料（Material）"
        Ws.Cells(4, 6) = "人工（labour）"
        Ws.Cells(4, 9) = "模具费用(mold fee)"
        Ws.Cells(5, 5) = "金额（amount）"
        'Ws.Cells(5, 6) = ""
        'Ws.Cells(5, 7) = ""
    ...
    Private Sub ExportToExcel()
        ...
        oCommand.CommandText = "select nvl(round(sum(tlf10*tlf12*(ccc23)),2),0) as t1 ,tlf20,pja01,pja02,pja05,pja08 from pja_file "
        ...
        End If
        oCommand.CommandText += " group by tlf20,pja01,pja02,pja05,pja08 order by tlf20 "
        oReader = oCommand.ExecuteReader()
        If oReader.HasRows() Then
            While oReader.Read()
                Ws.Cells(LineZ, 1) = oReader.Item("pja01")
                Ws.Cells(LineZ, 2) = oReader.Item("pja02")
                Ws.Cells(LineZ, 3) = oReader.Item("pja05")
                Ws.Cells(LineZ, 4) = oReader.Item("pja08")
        ...
        If kReader.HasRows() Then
            While kReader.Read()
                ...
                Ws.Cells(LineZ, 8) = 35
                Ws.Cells(LineZ, 9) = kReader.Item("ehour") * 35
                LineZ += 1
            End While
        End If
        kReader.Close()
        ...
        Ws.Activate()
        AdjustExcelFormat4()
        oCommand.CommandText = "select tlf19,pmc03,rva06,rva01,tlf905,rvv36,tlf01,ima02,ima021,tlf11,rvb08,tlf10,rvv38t,pmm22,pmm42,rvv39 * pmm42,(rvv39t - rvv39)*pmm42,rvv39t * pmm42,rvv39,(rvv39t - rvv39),rvv39t,tlf20 from TLF_FILE "
        ...
        If oReader.HasRows() Then
            While oReader.Read()
                ...
                For i As Int16 = 2 To oReader.FieldCount - 1 Step 1
