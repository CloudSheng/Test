        ...
        If oReader.HasRows() Then
            While oReader.Read()
                ...
                If oReader.Item(3) <> oReader.Item(4) Then
                    oCommander2.CommandText = "select Round(smd06/smd04,3) from smd_file where smd01 = '" & oReader.Item(0) & "' and smd02 = '" & oReader.Item(3) & "' and smd03 = '" & oReader.Item(4) & "'"
                    oCommander2.CommandText += " union all "
                    oCommander2.CommandText += "select Round(smd04/smd06,3) from smd_file where smd01 = '" & oReader.Item(0) & "' and smd02 = '" & oReader.Item(4) & "' and smd03 = '" & oReader.Item(3) & "'"
