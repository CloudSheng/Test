...
Public Class Form50
    ...
    Private Sub SaveExcel()
        SaveFileDialog1.FileName = "HAC_SALES_OVERVIEW"
    ...
    Private Sub ExportToExcel()
        ...
        Ws.Activate()
        Ws.Name = "HAC monthly sales overview"
        AdjustExcelFormat()
        oCommand.CommandText = "select distinct oga03,oga032 from hkacttest.oga_file where oga02 between to_date('"
            ...
            While oReader.Read()
                ...
                For i As Integer = 1 To AllM Step 1
                    If i = AllM Then
                        D2 = DstartE
                    End If
                    oCommand2.CommandText = "select nvl(round(sum(ogb14 * oga24),2),0) from hkacttest.oga_file,hkacttest.ogb_file where oga01 = ogb01 and oga02 between to_date('"
        ...
        Ws.Name = "Part"
        AdjustExcelFormat()
        oCommand.CommandText = "select distinct oga03,oga032 from hkacttest.oga_file,hkacttest.ogb_file where oga01 = ogb01 and ogb04 <> 'AC0000000000' AND oga02 between to_date('"
        oCommand.CommandText += DStartN.ToString("yyyy/MM/dd") & "','yyyy/mm/dd') and to_date('"
        oCommand.CommandText += DstartE.ToString("yyyy/MM/dd") & "','yyyy/mm/dd') and ogapost = 'Y' " 'order by oga03"
        If Not String.IsNullOrEmpty(OCC01) Then
            oCommand.CommandText += " AND oga03 = '" & OCC01 & "' "
        ...
        If oReader.HasRows() Then
            While oReader.Read()
                ...
                For i As Integer = 1 To AllM Step 1
                    ...
                    oCommand2.CommandText = "select nvl(round(sum(ogb14 * oga24),2),0) from hkacttest.oga_file,hkacttest.ogb_file where oga01 = ogb01 and oga02 between to_date('"
                    oCommand2.CommandText += D1.ToString("yyyy/MM/dd") & "','yyyy/mm/dd') and to_date('"
                    oCommand2.CommandText += D2.ToString("yyyy/MM/dd") & "','yyyy/mm/dd') AND ogb04 <> 'AC0000000000' and ogapost = 'Y' and oga03 = '" & oReader.Item("oga03") & "'"
                    Dim GetSum As Decimal = oCommand2.ExecuteScalar()
                    If GetSum > 0 Then
                        Ws.Cells(LineZ, i + 1) = GetSum
                    End If
        ...
        Ws.Activate()
        Ws.Name = "HAC monthly returned overview"
        AdjustExcelFormat()
        oCommand.CommandText = "select distinct oha03,oha032 from hkacttest.oha_file where oha02 between to_date('"
        oCommand.CommandText += DStartN.ToString("yyyy/MM/dd") & "','yyyy/mm/dd') and to_date('"
            ...
            While oReader.Read()
                ...
                For i As Integer = 1 To AllM Step 1
                    If i = AllM Then
                        D2 = DstartE
                    End If
                    oCommand2.CommandText = "select nvl(round(sum(ohb14 * oha24 * -1),2),0) from hkacttest.oha_file,hkacttest.ohb_file where oha01 = ohb01 and oha02 between to_date('"
                    oCommand2.CommandText += D1.ToString("yyyy/MM/dd") & "','yyyy/mm/dd') and to_date('"
