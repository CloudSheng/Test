Public Class Form147
    ...
    Private Sub ExportToExcel()
        ...
        mSQLS1.CommandText += ",convert(decimal(10,3),isnull((case when station = '0587' and paravalue.parameter = '0587_CW_AFTER' then paravalue.value end),0)) as t2,s1.value  as u1,s2.value as u2 "
