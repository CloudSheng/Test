...
Public Class Form83
    ...
    Private Sub SaveExcel()
        SaveFileDialog1.FileName = "OverHead_Report"
    ...
    Private Sub ExportToExcel()
        ...
        'oRng = Ws.Range("C7", Ws.Cells(LineZ, 7))
        'oRng.Interior.Color = Color.FromArgb(255, 231, 153)
        'oRng = Ws.Range("H7", Ws.Cells(LineZ, 11))
        'oRng.Interior.Color = Color.FromArgb(217, 226, 243)
        'oRng = Ws.Range("L7", Ws.Cells(LineZ, 14))
        'oRng.Interior.Color = Color.FromArgb(197, 224, 178)

        ' 第二頁
        Ws = xWorkBook.Sheets(2)
        Ws.Name = "Overhead 部门明细(新)"
        Ws.Activate()
        AdjustExcelFormat1()
        oCommand3.CommandText = "select distinct aao02 from ( select aao02 from aao_file where aao01 like '5101%' union all select tc_bud08 from tc_bud_file where tc_bud07 like '5101%' ) where aao02 <> 'D9999'"
        ...
        oRng.Borders(xlInsideVertical).LineStyle = xlContinuous
        oRng.NumberFormat = "#,##0_ ;[Red]-#,##0 "
        'oRng = Ws.Range("D7", Ws.Cells(LineZ, 8))
        'oRng.Interior.Color = Color.FromArgb(255, 231, 153)
        'oRng = Ws.Range("I7", Ws.Cells(LineZ, 12))
        'oRng.Interior.Color = Color.FromArgb(217, 226, 243)
        'oRng = Ws.Range("M7", Ws.Cells(LineZ, 15))
        'oRng.Interior.Color = Color.FromArgb(197, 224, 178)
