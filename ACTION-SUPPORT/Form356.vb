...
Public Class Form356
    ...
    Dim l_tc_xma06 As String = String.Empty
    Dim l_tc_xma14 As String = String.Empty
    Dim l_tc_xma21 As String = String.Empty
    Dim l_tc_xmaud03 As String = String.Empty
    Dim l_tc_xmbud01 As String = String.Empty
    Dim ll_tc_xma19 As String = String.Empty

    Dim l_ofa23 As String = String.Empty
    Private Sub Form356_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim xPath As String = "C:\temp\import_declaration_trade_demo.xlsx"
    ...
    Private Sub ExportToExcel()
        ...
        If oReader.HasRows() Then
            While oReader.Read()
                ...
                If oReader.Item("tc_xmbud10") <> 0 Then
        ...
        oCommand.CommandText = "select tc_xmaud03,tc_xmaud04,tc_xma38,tc_xma10,tc_xma11,tc_xma13,tc_xma12,tc_xma15,tc_xma16,tc_xma17,tc_xma18,tc_xma19,to_char(tc_xma06,'yyyy/MM/dd') as c_tc_xma06 "
        oCommand.CommandText += " from tc_xma_file "
        oCommand.CommandText += "where tc_xma01 = '" & l_tc_xma01 & "' "
        oReader = oCommand.ExecuteReader()
        If oReader.HasRows() Then
            While oReader.Read()
                Ws.Cells(1, 1) = oReader.Item("tc_xmaud03")
                Ws.Cells(2, 1) = oReader.Item("tc_xmaud04")
                Ws.Cells(6, 3) = oReader.Item("tc_xma11")
                Ws.Cells(7, 3) = oReader.Item("tc_xma13")
                Ws.Cells(7, 6) = oReader.Item("tc_xma12")
                Ws.Cells(8, 2) = oReader.Item("tc_xma16")
                Ws.Cells(8, 5) = oReader.Item("tc_xma15")
                Ws.Cells(8, 7) = oReader.Item("tc_xma17")
                Ws.Cells(8, 9) = oReader.Item("tc_xma18")

                If Not oReader.Item("c_tc_xma06") Is DBNull.Value Then
                    l_tc_xma06 = oReader.Item("c_tc_xma06")
                End If
        ...
        oCommand.CommandText = "select tc_xmbud10,tc_xmbud01,tc_xmb02,tc_xmb12,tc_xmb03,tc_xmb04,tc_xmb13,tc_xmb16,tc_xmb15,tc_xmb05,tc_xmb11,tc_xmb12,tc_xmb17 "
        oCommand.CommandText += " from tc_xmb_file "
        oCommand.CommandText += "where tc_xmb01 = '" & l_tc_xma01 & "' "
        oCommand.CommandText += "order by tc_xmb02 "
        LineZ = 11
        ...
        If oReader.HasRows() Then
            While oReader.Read()
                Ws.Cells(LineZ, 1) = oReader.Item("tc_xmb02")
                Ws.Cells(LineZ, 2) = oReader.Item("tc_xmb03")
                Ws.Cells(LineZ, 3) = oReader.Item("tc_xmbud01")
                Ws.Cells(LineZ, 5) = oReader.Item("tc_xmb11")
                Ws.Cells(LineZ, 6) = oReader.Item("tc_xmb12")
                Ws.Cells(LineZ, 7) = oReader.Item("tc_xmb13")
                Ws.Cells(LineZ, 8) = oReader.Item("tc_xmb17")
                Ws.Cells(LineZ, 9) = oReader.Item("tc_xmb05")
                LineZ += 1
            End While
        End If
        oReader.Close()
        Ws.Cells(24, 5) = "=SUM(E11:E" & LineZ - 1 & ")"
        Ws.Cells(24, 7) = "=SUM(G11:G" & LineZ - 1 & ")"
        Ws.Cells(24, 8) = "=SUM(H11:H" & LineZ - 1 & ")"
        Ws.Cells(25, 3) = l_tc_xma06
        Ws.Cells(25, 8) = l_tc_xma06

        '进口发票
        Ws = xWorkBook.Sheets(3)
        oCommand.CommandText = "select tc_xmaud03,tc_xmaud04,tc_xma29,tc_xma02,tc_xma19,tc_xma11,tc_xma14 "
        oCommand.CommandText += " from tc_xma_file "
        oCommand.CommandText += "where tc_xma01 = '" & l_tc_xma01 & "' "
        oReader = oCommand.ExecuteReader()
        If oReader.HasRows() Then
            While oReader.Read()
                Ws.Cells(1, 1) = oReader.Item("tc_xmaud03")
                Ws.Cells(2, 1) = oReader.Item("tc_xmaud04")
                Ws.Cells(9, 2) = oReader.Item("tc_xma11")
                Ws.Cells(9, 4) = oReader.Item("tc_xma14")
                l_tc_xma19 = oReader.Item("tc_xma19")
            End While
        End If
        oReader.Close()

        oCommand.CommandText = "select tc_xmbud01,tc_xmbud10,tc_xmb02,tc_xmb04,tc_xmb13,tc_xmb12,tc_xmb16,tc_xmb15,tc_xmb05,tc_xmb11 "
        oCommand.CommandText += " from tc_xmb_file "
        oCommand.CommandText += "where tc_xmb01 = '" & l_tc_xma01 & "' "
        oCommand.CommandText += "order by tc_xmb02 "
        LineZ = 12
        ...
        If oReader.HasRows() Then
            While oReader.Read()
                Ws.Cells(LineZ, 1) = oReader.Item("tc_xmb02")
                Ws.Cells(LineZ, 2) = oReader.Item("tc_xmbud01")
                Ws.Cells(LineZ, 3) = oReader.Item("tc_xmb11")
                Ws.Cells(LineZ, 4) = oReader.Item("tc_xmb12")
                Ws.Cells(11, 5) = l_tc_xma19
                Ws.Cells(11, 6) = l_tc_xma19
                'Ws.Cells(LineZ, 5) = oReader.Item("tc_xmb16")
                Ws.Cells(LineZ, 6) = oReader.Item("tc_xmb15")
                LineZ += 1
            End While
        End If
        oReader.Close()
        Ws.Cells(25, 5) = l_tc_xma19
        Ws.Cells(25, 6) = "=SUM(F12:F" & LineZ - 1 & ")"

        '购销合同
        Ws = xWorkBook.Sheets(4)
        oCommand.CommandText = "select tc_xma02,tc_xmaud03,tc_xmaud04,tc_xma29,tc_xma02,tc_xma19,tc_xma11,tc_xma14,tc_xma21 "
        oCommand.CommandText += " from tc_xma_file "
        oCommand.CommandText += "where tc_xma01 = '" & l_tc_xma01 & "' "
        oReader = oCommand.ExecuteReader()
        If oReader.HasRows() Then
            While oReader.Read()
                Ws.Cells(4, 2) = oReader.Item("tc_xma11")
                Ws.Cells(4, 5) = oReader.Item("tc_xma02")
                Ws.Cells(6, 2) = oReader.Item("tc_xmaud03")
                Ws.Cells(7, 2) = oReader.Item("tc_xmaud04")
                l_tc_xma19 = oReader.Item("tc_xma19")
                l_tc_xma14 = oReader.Item("tc_xma14")
                l_tc_xma21 = oReader.Item("tc_xma21")
                l_tc_xmaud03 = oReader.Item("tc_xmaud03")
            End While
        End If
        oReader.Close()
        ...
        If oReader.HasRows() Then
            While oReader.Read()
                Ws.Cells(LineZ, 1) = oReader.Item("tc_xmb02")
                Ws.Cells(LineZ, 2) = oReader.Item("tc_xmbud01")
                Ws.Cells(LineZ, 3) = oReader.Item("tc_xmb12")
                Ws.Cells(LineZ, 4) = oReader.Item("tc_xmb11")
                Ws.Cells(16, 5) = l_tc_xma19
                Ws.Cells(16, 6) = l_tc_xma19
                'Ws.Cells(LineZ, 5) = oReader.Item("tc_xmb16")
                Ws.Cells(LineZ, 6) = oReader.Item("tc_xmb15")
                LineZ += 1
            End While
        End If
        oReader.Close()
        Ws.Cells(30, 6) = "=SUM(F17:F" & LineZ - 1 & ")"
        Ws.Cells(32, 2) = l_tc_xma14
        Ws.Cells(33, 2) = l_tc_xma21
        Ws.Cells(38, 2) = l_tc_xmaud03

    End Sub

    Private Sub SaveExcel()
        SaveFileDialog1.FileName = "import_declaration_trade"
