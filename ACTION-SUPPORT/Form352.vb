...
Public Class Form352
    ...
    Private Sub ExportToExcel()
        ...
        Ws.Activate()
        AdjustExcelFormat()
        oCommand.CommandText = "select aag01,aag02 from aag_file where aag01 like '660129%' and aag07 = 2 order by aag01"
    ...
    Private Sub AdjustExcelFormat()
        ...
        Ws.Cells(4, 2) = tYear & " Customer Claim"
    ...
    Private Sub ExportToExcel_1()
        ...
        oReader.Close()
        Ws.Cells(LineZ, 2) = "sut total in USD"
        Ws.Cells(LineZ, 3) = "=SUM(C15:C" & LineZ - 1 & ")"
        oRng = Ws.Range(Ws.Cells(LineZ, 3), Ws.Cells(LineZ, 3))
        'oRng.AutoFill(Destination:=Ws.Range(Ws.Cells(LineZ, 3), Ws.Cells(LineZ, 15)), Type:=xlFillDefault)
        oRng.AutoFill(Destination:=Ws.Range(Ws.Cells(LineZ, 3), Ws.Cells(LineZ, m_cnt + 3)), Type:=xlFillDefault)

        ' 劃線
        'oRng = Ws.Range("B15", Ws.Cells(LineZ, 15))
        If m_cnt = 1 Then
            oRng = Ws.Range("B15", Ws.Cells(LineZ, 4))
        End If
        If m_cnt = 2 Then
            oRng = Ws.Range("B15", Ws.Cells(LineZ, 5))
        End If
        If m_cnt = 3 Then
            oRng = Ws.Range("B15", Ws.Cells(LineZ, 6))
        End If
        If m_cnt = 4 Then
            oRng = Ws.Range("B15", Ws.Cells(LineZ, 7))
        End If
        If m_cnt = 5 Then
            oRng = Ws.Range("B15", Ws.Cells(LineZ, 8))
        End If
        If m_cnt = 6 Then
            oRng = Ws.Range("B15", Ws.Cells(LineZ, 9))
        End If
        If m_cnt = 7 Then
            oRng = Ws.Range("B15", Ws.Cells(LineZ, 10))
        End If
        If m_cnt = 8 Then
            oRng = Ws.Range("B15", Ws.Cells(LineZ, 11))
        End If
        If m_cnt = 9 Then
            oRng = Ws.Range("B15", Ws.Cells(LineZ, 12))
        End If
        If m_cnt = 10 Then
            oRng = Ws.Range("B15", Ws.Cells(LineZ, 13))
        End If
        If m_cnt = 11 Then
            oRng = Ws.Range("B15", Ws.Cells(LineZ, 14))
        End If
        If m_cnt = 12 Then
            oRng = Ws.Range("B15", Ws.Cells(LineZ, 15))
        End If
        ...
        oRng = Ws.Range("A14", Ws.Cells(LineZ, 1))
        oRng.Borders(xlEdgeLeft).LineStyle = xlContinuous
        oRng.Borders(xlEdgeTop).LineStyle = xlContinuous
        oRng.Borders(xlEdgeBottom).LineStyle = xlContinuous
        oRng.Borders(xlEdgeRight).LineStyle = xlContinuous
        ...
        'oRng = Ws.Range("C14", "N14")
        If m_cnt = 1 Then
            oRng = Ws.Range("C14", "C14")
        End If
        If m_cnt = 2 Then
            oRng = Ws.Range("C14", "D14")
        End If
        If m_cnt = 3 Then
            oRng = Ws.Range("C14", "E14")
        End If
        If m_cnt = 4 Then
            oRng = Ws.Range("C14", "F14")
        End If
        If m_cnt = 5 Then
            oRng = Ws.Range("C14", "G14")
        End If
        If m_cnt = 6 Then
            oRng = Ws.Range("C14", "H14")
        End If
        If m_cnt = 7 Then
            oRng = Ws.Range("C14", "I14")
        End If
        If m_cnt = 8 Then
            oRng = Ws.Range("C14", "J14")
        End If
        If m_cnt = 9 Then
            oRng = Ws.Range("C14", "K14")
        End If
        If m_cnt = 10 Then
            oRng = Ws.Range("C14", "L14")
        End If
        If m_cnt = 11 Then
            oRng = Ws.Range("C14", "M14")
        End If
        If m_cnt = 12 Then
            oRng = Ws.Range("C14", "N14")
        End If
    ...
    Private Sub AdjustExcelFormat1_1()
        ...
        End If
        oRng.NumberFormatLocal = "mmm-yy"
        'Ws.Cells(14, 3) = tDate.AddMonths(0)
        'Ws.Cells(14, 4) = tDate.AddMonths(1)
        'Ws.Cells(14, 5) = tDate.AddMonths(2)
        'Ws.Cells(14, 6) = tDate.AddMonths(3)
        'Ws.Cells(14, 7) = tDate.AddMonths(4)
        'Ws.Cells(14, 8) = tDate.AddMonths(5)
        'Ws.Cells(14, 9) = tDate.AddMonths(6)
        'Ws.Cells(14, 10) = tDate.AddMonths(7)
        'Ws.Cells(14, 11) = tDate.AddMonths(8)
        'Ws.Cells(14, 12) = tDate.AddMonths(9)
        'Ws.Cells(14, 13) = tDate.AddMonths(10)
        'Ws.Cells(14, 14) = tDate.AddMonths(11)
        'Ws.Cells(14, 15) = "YTD " & tYear
        For i = 1 To m_cnt
            Ws.Cells(14, i + 2) = tDate.AddMonths(i - 1)
        Next
        Ws.Cells(14, m_cnt + 3) = "YTD " & tYear

        ' 劃線
        'oRng = Ws.Range("B14", "O14")
        If m_cnt = 1 Then
            oRng = Ws.Range("B14", "D14")
        End If
        If m_cnt = 2 Then
            oRng = Ws.Range("B14", "E14")
        End If
        If m_cnt = 3 Then
            oRng = Ws.Range("B14", "F14")
        End If
        If m_cnt = 4 Then
            oRng = Ws.Range("B14", "G14")
        End If
        If m_cnt = 5 Then
            oRng = Ws.Range("B14", "H14")
        End If
        If m_cnt = 6 Then
            oRng = Ws.Range("B14", "I14")
        End If
        If m_cnt = 7 Then
            oRng = Ws.Range("B14", "J14")
        End If
        If m_cnt = 8 Then
            oRng = Ws.Range("B14", "K14")
        End If
        If m_cnt = 9 Then
            oRng = Ws.Range("B14", "L14")
        End If
        If m_cnt = 10 Then
            oRng = Ws.Range("B14", "M14")
        End If
        If m_cnt = 11 Then
            oRng = Ws.Range("B14", "N14")
        End If
        If m_cnt = 12 Then
            oRng = Ws.Range("B14", "O14")
        End If
    ...
    Private Sub SaveExcel()
        SaveFileDialog1.FileName = "group_customer_claim_amount"
