...
Public Class Form53
    ...
    Private Sub SaveExcel()
        SaveFileDialog1.FileName = "DAC_overdue_AR_aging_report_" & DStartN.ToString("yyyyMMdd")
    ...
    Private Sub ExportToExcel()
        ...
        End If
        oReader.Close()
        If THasRows = True Then
            ' 加總
            Ws.Cells(LineX, 1) = "Total overdue AR_RMB"
    ...
    Private Sub AdjustExcelFormat2()
        ...
        Ws.Cells(8, 1) = "Total overdue AR_RMB"
        oRng = Ws.Range("A8", "B8")
        oRng.Interior.Color = Color.Yellow
