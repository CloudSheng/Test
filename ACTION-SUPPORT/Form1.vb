Public Class Form1
    ...
    Private Sub CalloffToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CalloffToolStripMenuItem.Click
        Form365.Show()
        Form365.Focus()
    End Sub

    Private Sub 标准毛利率报表ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 标准毛利率报表ToolStripMenuItem.Click
    ...
    Private Sub SN扫描ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SN扫描ToolStripMenuItem.Click
        Form188.Show()
        Form188.Focus()
    End Sub

    Private Sub 电费占产品销售收入ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 电费占产品销售收入ToolStripMenuItem.Click
        Form190.Show()
        Form190.Focus()
    End Sub

    Private Sub 单阶材料标准成本ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 单阶材料标准成本ToolStripMenuItem.Click
        Form191.Show()
        Form191.Focus()
    End Sub

    Private Sub QCStatusToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles QCStatusToolStripMenuItem.Click
        Form192.Show()
        Form192.Focus()
    End Sub
