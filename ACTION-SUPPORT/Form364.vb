...
Public Class Form364
    ...
    Private Sub ExportToExcel()
        ...
        oCommand.CommandText = "select ofa0451,ofa0452,ofa0453,ofa01,to_char(ofa02,'YYYY/MM/DD') as ofa02,ogb04,ogb11,NVL(ogd09,0) as ogd09,NVL(ogd12b,0) as ogd12b,ofa04 "
